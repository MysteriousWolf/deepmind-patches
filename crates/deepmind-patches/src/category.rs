...
impl Category {
    ...
    /// The name as the instrument writes it, which is also the folder name.
    #[must_use]
    ...
    /// The category a folder or display name refers to. Case-sensitive.
    #[must_use]
...
mod tests {
    ...
    fn values_round_trip() {
        for category in Category::ALL {
            ...
            assert_eq!(Category::label_of_value(category.value()), category.name());
        }
